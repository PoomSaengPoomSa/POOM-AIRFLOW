...
with DAG(
    ...
    run_customer_info_agent = BashOperator(
        ...
        bash_command='''
        curl --fail-with-body -sS -H "Content-Type: application/json" -X POST -d '{"u_id": "pb_b1_1"}' http://poom-alb-1963738321.ap-northeast-2.elb.amazonaws.com:8000/api/v1/customer-main/run
        ''',
